    ...
    get actions() {
        ...
        const otherActions = [
            new Action('Second Wind', 'Bonus', `1d10+${this.level}`,
                ...
                range = null, remainingUses = 1, totalUses = 1),
            ...
            new Action('Invoke Fire Rune', 'Free', `Damage: 2d6 fire`,
                ...
                range = null, remainingUses = 1, totalUses = this.level < 15 ? 1 : 2),
            ...
            new Action('Invoke Frost Rune', 'Reaction', null,
                ...
                state = new State(false, () => {
                    ['Athletics', 'STR Saving throws', 'STR Checks', 'CON Saving throws', 'CON Checks'].forEach(i => {
                        this.miscModifiers[i] ? this.miscModifiers[i] += 2 : this.miscModifiers[i] = 2;
                    });
                }, () => {
                    ['Athletics', 'STR Saving throws', 'STR Checks', 'CON Saving throws', 'CON Checks'].forEach(i => {
                        if (this.miscModifiers[i]) this.miscModifiers[i] -= 2;
                    });
                })
            ),
            ...
            new Action('Invoke Hill Rune', 'Bonus', null,
                ...
                range = null, remainingUses = 1, totalUses = this.level < 15 ? 1 : 2,
                state = new State(false, () => {
                    this.resistances.push('Bludgeoning, piercing, and slashing (while Hill Rune is invoked)');
                }, () => {
                    this.resistances = this.resistances.filter(r => r !== 'Bludgeoning, piercing, and slashing (while Hill Rune is invoked)');
                })
            ),
            
            new Action('Invoke Storm Rune', 'Bonus', null,
                `In addition, you can invoke the rune as a bonus action to enter a prophetic state for 1 minute or until you’re incapacitated. Until the state ends, when you or another creature you can see within 60 feet of you makes an attack roll, a saving throw, or an ability check, you can use your reaction to cause the roll to have advantage or disadvantage. Once you invoke this rune, you can’t do so again until you finish a short or long rest.`,
                range = 60, remainingUses = 1, totalUses = this.level < 15 ? 1 : 2,
                state = new State(false, () => {}, () => {})),
...
You can use this feature a number of times equal to your proficiency bonus, and you regain all expended uses of it when you finish a long rest.`,
                range = null, remainingUses = 4, totalUses = this.proficiencyBonus, 
                state = new State(false, () => {
                    this.advantage = [...this.advantage, "STR Checks (during Augmented Size)", "STR Saving throws (during Augmented Size)"];
                }, () => {
                    this.advantage = this.advantage.filter(a => !["STR Checks (during Augmented Size)", "STR Saving throws (during Augmented Size)"].includes(a));
                })
            ),
